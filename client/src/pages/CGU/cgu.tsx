      ...
      <section className="legalmentions-container">
        ...
        <p className="legalMentions-text">
          ...
          <ul>
            ...
            <li>
              {" "}
              D’acheter des produits avec ou sans création de compte
              utilisateur.
            </li>
            <li>
              {" "}
              De bénéficier d'un espace personnel pour les utilisateurs
              inscrits, facilitant le suivi des commandes et la gestion des
              préférences.
            </li>
          </ul>
        </p>
        ...
        <p className="legalMentions-text">
          Article 5 : Responsabilités des utilisateurs Les utilisateurs
          s’engagent à :
          <ul>
            <li>
              Utiliser le Site de manière conforme à la loi et aux présentes
              CGU.
            </li>
            <li>
            ...
            <li>
              Ne pas tenter d’altérer le fonctionnement du Site ou de ses
              contenus (piratage, injection de code malveillant, etc.).
            </li>
          </ul>
        </p>
        <p className="legalMentions-text">
          Article 6 : Propriété intellectuelle Tous les contenus présents sur le
          Site (textes, images, logos, designs) sont protégés par les lois sur
          la propriété intellectuelle. Toute reproduction, même partielle, sans
          autorisation écrite est interdite.
        </p>
        <p className="legalMentions-text">
          Article 7 : Modifications des CGU Les présentes CGU peuvent être
          modifiées à tout moment par by.Nouchka. Les utilisateurs seront
          informés par une notification sur le Site.
        </p>
      </section>
    </>
  );
