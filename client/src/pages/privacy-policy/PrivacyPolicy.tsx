    ...
    <>
      <section className="legalmentions-container">
        ...
        <p className="legalMentions-text">
          ...
          Cette politique explique comment nous collectons, utilisons, stockons
        ...
        <p className="legalMentions-text">
          ...
          <ul>
            {" "}
            <li>
              Nom de l’entreprise : by.Nouchka Adresse : 3 cours de l’intendance
              33000 Bordeaux.
            </li>{" "}
            <li>
              {" "}
              E-mail : nina.rch16@gmail.com Numéro SIRET : 93801667200017.
            </li>
          </ul>
        </p>
        <p className="legalMentions-text">
          ...
          <p className="legalMentions-text">
            ...
            <p>
              ...
              <ol>
                <li>
                  La gestion des commandes : Traitement, expédition, facturation
                  et suivi des commandes.
                </li>
                <li>
                  Le service client : Répondre à vos demandes, traiter vos
        ...
        <p className="legalMentions-text">
          ...
          <ul>
            <li>
              ...
              commerciale, puis archivées pour la durée légale (ex. : 5 ans pour
              les factures).
            </li>
            <li>
        ...
        <p className="legalMentions-text">
          ...
          <ul>
            ...
            <li>
              Cryptage des données de paiement via des passerelles sécurisées
              (ex. : SSL/TLS).
            </li>
            <li>
